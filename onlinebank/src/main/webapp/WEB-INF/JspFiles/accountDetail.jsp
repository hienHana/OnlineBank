	...
	<div class="container" align="center">
		...
		<table>
			<tr>
				...
				<!-- <td><br><a href="/admin">The Admin Page</a>&nbsp;&nbsp;&nbsp;</td> -->				
		...
		<p><strong>Account Transactions</strong></p>
		<table border="1" class="table table-striped">
			<tr>
				...
				<th>Comments</th>
				<th>Amount</th>
				<th>Who Makes Transaction</th>
			</tr>
		
			<c:forEach items="${transactions}" var="transaction">
				<tr>
					<td>${transaction.transId}</td>
					<td>${transaction.transFromAccountNo}</td>
					<td>${transaction.transToAccountNo}</td>
					<td>${transaction.transType}</td>
					<td>${transaction.transDateTime}</td>
					<td>${transaction.transComments}</td>
					<td>${transaction.transAmount}</td>
					<td>${transaction.whoMakesTrans}</td>
				</tr>
			</c:forEach>
		</table>
	</div>
